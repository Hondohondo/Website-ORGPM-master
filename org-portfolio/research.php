        ...
        <header class="header" id="research">
            ...
            <div class="service__container">
                <div class="service-content">
                    <h1 class="text-service">Research</h1>
                </div>
                <hr class="hr-line">
        ...
        <section class="section-research" id="stickyy">
            ...
            <div class="row">
                <div class="service-type">
                    ...
                    <div>
                        <p>
                            Research papers and other newsworthy market views and insights can be found here.  
                            Documents are listed by date and subject.  
                        </p>

                        <ul>
                            <li class="research-links">
                                <i class="ion-ios-circle-filled icon-small"></i>
                                <a href="#">April 2013</a>
                            </li>
                            <li class="research-links">
                                <i class="ion-ios-circle-filled icon-small"></i>
