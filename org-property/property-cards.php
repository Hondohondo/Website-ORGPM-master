...
<!--            <a href="#card-one" class="home__btn">View Property</a>-->
            <a href="../img/property/reception-big.jpg" data-lightbox="mygallery" data-title="ORG Property" class="home__btn">View Property</a>
        </div>

    </div>
    <div class="col-1-of-3">
        <div class="home">
            <img src="../img/property/hospital-small.jpg" alt="Hospital" class="home__img">
...
<!--            <a href="showcase-1.php" class="home__btn">View Property</a>-->
            <a href="../img/property/hospital-big.jpg" data-lightbox="mygallery-2" data-title="ORG Property-2" class="home__btn">View Property</a>
        </div>

    </div>
    <div class="col-1-of-3">
        <div class="home">
            <img src="../img/property/flower-small.jpg" alt="Marble Room" class="home__img">
            ...
            <a href="../img/property/flowers.jpg" data-lightbox="mygallery-3" data-title="ORG Property" class="home__btn">View Property</a>
        </div>
